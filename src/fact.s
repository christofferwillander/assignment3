...
negative:						# if the input values i negativ, we calculate the fact of the positive value and then convert to negative
	movq	$1, %r9
	negq	%rax
	movq	%rax, %r8
	subq	$1, %r8	
...
negativeend:
	negq	%rax				# adding the '-' to the return
	popq	%r8
	popq	%r9
	ret
